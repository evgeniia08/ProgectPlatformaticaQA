...
public final class ChevronEntityBaseEditPage extends EntityBaseEditPage<ChevronPageEntityBase> {

    public ChevronEntityBaseEditPage(WebDriver driver) {
        super(driver);
    }
    ...
    @Override
    protected ChevronPageEntityBase createPage() {
        return new ChevronPageEntityBase(getDriver());
    }

    public ChevronEntityBaseEditPage chooseRecordStatus() {
        statusButton.click();
    ...
    public ChevronEntityBaseEditPage sendKeys(String comments, String int_, String decimal, String Time, String Data) {
