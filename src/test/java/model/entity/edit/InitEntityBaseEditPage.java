...
public class InitEntityBaseEditPage extends EntityBaseEditPage<InitPageEntityBase> {
    ...
    public InitEntityBaseEditPage(WebDriver driver) {
        super(driver);
    }
    ...
    @Override
    protected InitPageEntityBase createPage(){
