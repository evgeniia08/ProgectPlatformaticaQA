...
public class DefaultEntityBaseEditPage extends EntityBaseEditPage<DefaultPageEntityBase> {
    ...
    public DefaultEntityBaseEditPage(WebDriver driver) {
        super(driver);
    }

    @Override
    protected DefaultPageEntityBase createPage() {
