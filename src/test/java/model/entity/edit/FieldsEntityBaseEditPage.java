...
public final class FieldsEntityBaseEditPage extends EntityBaseEditPage<FieldsPageEntityBase> {
    ...
    public FieldsEntityBaseEditPage(WebDriver driver) {
        super(driver);
    }

    public FieldsEntityBaseEditPage fillTitle(String title) {
        fill(getWait(), inputTitle, title);
        return this;
    }

    public FieldsEntityBaseEditPage fillComments(String comments) {
        fill(getWait(), inputComments, comments);
        return this;
    }

    public FieldsEntityBaseEditPage fillInt(String int_) {
        fill(getWait(), inputInt, int_);
        return this;
    }

    public FieldsEntityBaseEditPage fillDecimal(String decimal) {
        fill(getWait(), inputDecimal, decimal);
        return this;
    }

    public FieldsEntityBaseEditPage fillDate(String date) {
        fill(getWait(), inputDate, date);
        return this;
    }

    public FieldsEntityBaseEditPage fillDateTime(String dateTime) {
        fill(getWait(), inputDateTime, dateTime);
        return this;
    }

    public FieldsEntityBaseEditPage sendKeys(String title, String comments, String int_, String decimal, String date, String datetime) {
        fill(getWait(), inputTitle, title);
        fill(getWait(), inputComments, comments);
        fill(getWait(), inputInt, int_);
        fill(getWait(), inputDecimal, decimal);
    ...
    public FieldsEntityBaseEditPage selectUser(String user) {
    ...
    @Override
    protected FieldsPageEntityBase createPage() {
