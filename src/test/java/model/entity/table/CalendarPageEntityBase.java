...
public final class CalendarPageEntityBase extends EntityBaseTablePage<CalendarPageEntityBase, CalendarEditPage> {
    ...
    public CalendarPageEntityBase(WebDriver driver) {
        super(driver);
    }
    ...
    public CalendarPageEntityBase clickThisList() {
        clickList.click();
