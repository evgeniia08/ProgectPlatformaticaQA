...
import model.entity.edit.ChevronEntityBaseEditPage;
...
public final class ChevronPageEntityBase extends EntityBaseTablePage<ChevronPageEntityBase, ChevronEntityBaseEditPage> {

    public ChevronPageEntityBase(WebDriver driver) {
        super(driver);
    }

    @Override
    protected ChevronEntityBaseEditPage createEditPage() {
        return new ChevronEntityBaseEditPage(getDriver());
    }
    ...
    public ChevronPageEntityBase clickRowToView(String xpath) {
    ...
    public ChevronPageEntityBase orderBy() {
        getDriver().findElement(By.xpath("//a[@class='nav-link active']")).click();
        return this;

    }

    public ChevronPageEntityBase drugUp() throws InterruptedException {
